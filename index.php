...
<title>Project Worlds || RR EXAM </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">RR EXAM</span></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content mdcontent">
      <div class="modal-header">
        <button type="button" class="btn-close text-center" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h1 class="modal-title title1 text-center textdark">Log In</h1>
      </div>
      <div class="modal-body">
        <form class="form-horizontal loginform" action="login.php?q=index.php" method="POST">
<fieldset>
...
<div class="text-center mt-5">
      <button type="submit" class="btn btn-primary btnlogin">Log in</button>
      </div>
      </div>
...
<!-- sign in form begins -->  
  <form class="form-horizontal myform" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
...
<footer>
  <div class="row-footer">
    ...
    <div class="adr-email">
      <span>Address</span>
      <ul class="">
        <li class="location"><a><i class="fas fa-map-pin"></i>Sylhet, Dhakadakshin</a></li>
        <li class="email"><a href="mailto:rifat123@gmail.com?subject=subject text">rifat123@gmail.com</a></li>
      </ul>
    </div>
  ...
  <div class="row-footer">
    <div class="right-dis">Made with <i style="color: red; font-size: 12px;" class="fas fa-heart"></i> by <strong>RR</strong></div>
    <div class="left-dis">Copyright <strong>CodePy</strong> © 2022. All the rights are reserved.</div>
  </div>
